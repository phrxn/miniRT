...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/15 16:07:06 by dmanoel-          #+#    #+#             */
/*   Updated: 2024/05/26 04:42:21 by gacalaza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	syntax_plane(t_list *token_list)
{
	...
	if (!dict_is_a_separator_property(token_tmp))
		return (ERR_SYNTAX);
	if (check_property_syntax_color(ft_lstget(token_list, 14)))
		return (ERR_PROPERTY_COLOR);
	token_tmp = (t_token *)ft_lstget(token_list, 19)->content;
