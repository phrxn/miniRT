...
void	syntax_plane_test1()
{
//test 1 valid syntax
	t_token test1Tokens[20];
	test1Tokens[ 0].text = "pl";    test1Tokens[ 0].type = identifier;
	...
	test1Tokens[14].text = "120";   test1Tokens[14].type = pos_int;
	test1Tokens[15].text = ",";     test1Tokens[15].type = separator_value;
	test1Tokens[16].text = "80";    test1Tokens[16].type = pos_int;
	test1Tokens[17].text = ",";     test1Tokens[17].type = separator_value;
	test1Tokens[18].text = "9";     test1Tokens[18].type = pos_int;
	test1Tokens[19].text = NULL;    test1Tokens[19].type = eol;
	...
	test1List[19].content = &test1Tokens[19]; test1List[19].next = NULL;

	assert_svalue(OK_SYNTAX, syntax_plane(test1List), "test1 valid syntax");
}

void	syntax_plane_test(int argc, char **argv)
{
	if (argc != 1 &&  strcmp(argv[1], "syntax_plane_test") != 0)
		return ;
	create_title("syntax_plane_test");
