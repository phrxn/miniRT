...
static void normal_at_sphere_test()
{
	...
	t_shape  *test1Sphere = create_shape(TYPE_SPHERE);
	...
	t_shape  *test2Sphere =  create_shape(TYPE_SPHERE);
	...
	t_shape  *test3Sphere = create_shape(TYPE_SPHERE);
	...
	t_shape  *test4Sphere = create_shape(TYPE_SPHERE);
	...
	t_shape  *test5Sphere =  create_shape(TYPE_SPHERE);
	...
	t_shape  *test6Sphere =  create_shape(TYPE_SPHERE);
