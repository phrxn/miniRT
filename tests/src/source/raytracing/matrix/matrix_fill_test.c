...
static void	matrix_fill_translation_test()
{
	...
	t_matrix *test1MNewPoint = matrix_create_multip(test1Mtrans, test1MPoint);
	...
	t_matrix *test2MNewPoint = matrix_create_multip(test2MInverse, test2MPoint);
	...
	t_matrix *test3MNewPoint = matrix_create_multip(test3Mtrans, test3MVector);
...
static void	matrix_fill_scaling_test()
{
	...
	t_matrix *test1MNewPoint = matrix_create_multip(test1MScaling, test1MPoint);
	...
	t_matrix *test2MNewVector = matrix_create_multip(test2MScaling, test2MPoint);
	...
	t_matrix *test3MNewPoint = matrix_create_multip(test3MInverse, test3MVector);
	...
	t_matrix *test4MNewPoint = matrix_create_multip(test4MScaling, test4MPoint);
...
static void	matrix_fill_rot_x_test()
{
	...
	t_matrix *test1MPoint2 = matrix_create_multip(test1MHalfQuarter, test1MPoint);
	...
	t_matrix *test1MPoint3 = matrix_create_multip(test1MFullQuarter, test1MPoint);
	...
	t_matrix *test2MPoint2 = matrix_create_multip(test3Minverse, test2MPoint);
...
static void	matrix_fill_shearing_test()
{
	...
	t_matrix   *test1NewPoint = matrix_create_multip(test1Matrix1, test1Point);
	...
	t_matrix   *test2NewPoint = matrix_create_multip(test2Matrix1, test2Point);
	...
	t_matrix   *test3NewPoint = matrix_create_multip(test3Matrix1, test3Point);
	...
	t_matrix   *test4NewPoint = matrix_create_multip(test4Matrix1, test4Point);
	...
	t_matrix   *test5NewPoint = matrix_create_multip(test5Matrix1, test5Point);
	...
	t_matrix   *test6NewPoint = matrix_create_multip(test6Matrix1, test6Point);
